                ...
                VStack {
                    HStack {
                        Image(systemName: "person.crop.circle.fill")
                            ...
                            .clipShape(Circle())
                            .padding(.leading)
                            .shadow(color: Color.black.opacity(0.12), radius: 5, x: 5, y: 5)
                        TextField("Your Email".uppercased(), text: $email).keyboardType(.emailAddress)
                            .font(.subheadline)
                    ...
                    HStack {
                        Image(systemName: "lock.fill")
                            ...
                            .padding(.leading)
                            .shadow(color: Color.black.opacity(0.12), radius: 5, x: 5, y: 5)
                        SecureField("Password".uppercased(), text: $password).keyboardType(.default)
                            .font(.subheadline)
                            //                        .textFieldStyle(RoundedBorderTextFieldStyle())
                            .padding(.horizontal)
                            .frame(height: 44)
